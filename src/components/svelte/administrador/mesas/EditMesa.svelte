<script>
    import { updateMesa, getMesa } from "../../../services/mesasService";
    import { getRole, fetchUserRole } from "../../../services/authService";
    import { onMount } from "svelte";

    export let id;
    let mesa = { nombre: "", estado: "", capacidad: "" };
...
<h1 class="text-3xl uppercase font-semibold pb-10">Actualizar Mesa</h1>
